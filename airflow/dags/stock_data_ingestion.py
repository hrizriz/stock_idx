...
def sensing_data():
    ...
    # Mencari file yang sesuai dengan pola
...
def import_excel_files():
    ...
    # Mencari semua file yang sesuai dengan pola dan mencatat tanggalnya
    files_with_dates = []
    ...
    # Mengurutkan file berdasarkan tanggal, ambil yang terbaru
    ...
    try:
        ...
        # Log jumlah saham yang diproses ke database untuk pelacakan
        cur.execute("""
